...
public class PostsApiControllerTest extends TestCase {
    ...
    public void Posts_수정된다() throws Exception {
        ...
        List<Posts> all = postsRepository.findAll();
        assertThat(all.get(0).getTitle()).isEqualTo(expectedTitle).isEqualTo(expectedTitle);
        assertThat(all.get(0).getContent()).isEqualTo(expectedContent).isEqualTo(expectedContent);
    }
